...
function handleFormSubmit() {
    ...
    if (languageID == "en" || languageID == null) {
        if (service == 1) {
            if (toilet == 1) {
                if (bedroom == 1) {
                    hoursworkers = "4 Hours 1 Worker";
                } else if (bedroom == 2) {
                    hoursworkers = "4 Hours 1 Worker";
                } else if (bedroom == 3) {
                    hoursworkers = "4 Hours 1 Worker";
    ...
    } else if (languageID == "my") {
        if (service == 1) {
            if (toilet == 1) {
                if (bedroom == 1) {
                    hoursworkers = "4 Jam 1 Pekerja";
                } else if (bedroom == 2) {
                    hoursworkers = "4 Jam 1 Pekerja";
                } else if (bedroom == 3) {
                    hoursworkers = "4 Jam 1 Pekerja";
                    ...
                    hoursworkers = "4 Jam 2 Pekerja atau 8 Jam 1 Pekerja";
                } else if (bedroom == 6) {
                    hoursworkers = "4 Jam 2 Pekerja atau 8 Jam 1 Pekerja";
                } else if (bedroom == 7) {
                    hoursworkers = "4 Jam 2 Pekerja atau 8 Jam 1 Pekerja";
                } else if (bedroom == 8) {
                    hoursworkers = "4 Jam 3 Pekerja";
                } else if (bedroom == 9) {
                    hoursworkers = "4 Jam 3 Pekerja";
                } else if (bedroom == 10) {
                    hoursworkers = "4 Jam 3 Pekerja";
        ...
        if (service == 1) {
            if (toilet == 1) {
                if (bedroom == 1) {
                    ...
                    hoursworkers = "4 小时 2 工人 或 8 小时 1 工人";
                } else if (bedroom == 6) {
                    hoursworkers = "4 小时 2 工人 或 8 小时 1 工人";
                } else if (bedroom == 7) {
                    hoursworkers = "4 小时 2 工人 或 8 小时 1 工人";
                } else if (bedroom == 8) {
                    hoursworkers = "4 小时 3 工人";
                } else if (bedroom == 9) {
                    hoursworkers = "4 小时 3 工人";
                } else if (bedroom == 10) {
                    hoursworkers = "4 小时 3 工人";
